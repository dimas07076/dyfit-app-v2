...
import tokenRoutes from './src/routes/tokenRoutes.js'; // <-- 1. IMPORTAÇÃO ADICIONADA
...
apiRouter.use('/admin', adminPlanosRoutes);
apiRouter.use('/personal', personalPlanosRoutes);
...
apiRouter.use('/tokens', authenticateToken, tokenRoutes); // <-- 2. REGISTRO DA ROTA ADICIONADO

apiRouter.use('/aluno', alunoApiRoutes);
apiRouter.use('/alunos', alunoApiRoutes);
