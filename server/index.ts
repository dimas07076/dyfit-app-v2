...
import planTransitionRoutes from './src/routes/planTransitionRoutes.js';
...
apiRouter.use('/plan-transition', authenticateToken, planTransitionRoutes); // Plan transition routes (auth applied)
